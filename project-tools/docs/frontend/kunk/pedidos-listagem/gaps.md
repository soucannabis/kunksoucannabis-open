...
- [x] Ação em massa para os pedidos marcados com checkbox.
- [x] PDF com itens agregados, registro de dispensação e receitas disponíveis.
- [x] Marca `production_owner` após a exportação, sem substituir um responsável existente.
